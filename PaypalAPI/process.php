<?php
session_start();
include_once("../libs/paypal.conf.php");
...
if($_POST) //Post Data received from product list page.
{
    ...
    {
        $id 	= filter_var($_POST['item_code'][$key], FILTER_SANITIZE_STRING); 
		
		$results = $dbc->query("SELECT Name, Description, Price FROM Donation WHERE ID='$id' LIMIT 1");
